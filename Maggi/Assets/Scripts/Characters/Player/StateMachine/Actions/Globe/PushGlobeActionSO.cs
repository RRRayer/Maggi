...
[CreateAssetMenu(fileName = "PushGlobeAction", menuName = "State Machines/Actions/Push Globe Action")]
public class PushGlobeActionSO : StateActionSO<PushGlobeAction> 
{
	public float pushForce;
	public float upForce;
}

public class PushGlobeAction : StateAction
{
	private PushGlobeActionSO _originSO => (PushGlobeActionSO)base.OriginSO;
